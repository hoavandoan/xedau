...
export function getData() {
    ...
    return fetch(url)
        ...
        .then(res=>{
            ...
            const infoCar = ['carOwner','phoneNumber','address','from','to','price','timeStart','timeEnd','timeGoBackStart','timeGoBackEnd','image','category','note','favorite']
